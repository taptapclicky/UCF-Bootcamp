...
app.post('/api/reviews', (req, res) => {
  ...
  // creates variables for the object to run through
  ...
  // this is to make sure all criterea is met 
  if (product && review && username) {
    ...
    // if everything goes through and meets all critera post will be logged
    res.status(201).json(response);
  } else {
    // TODO: Add a comment describing the purpose of the else statement in this POST request.
    // if the previous criiterea was not met then it will release an error 
