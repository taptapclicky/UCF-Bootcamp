...
// in this a fliter runs through the originalArray and uses the isprime function to check if each number is prime. it creates and returns a new array that includes all prime numbers
const primeArray = originalArray.filter(isPrime);


// TODO: Describe how filter is working in this example. What will the value of moreThan5Array be? 
// a filter runs through the original
